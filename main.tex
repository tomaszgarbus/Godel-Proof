...
The first three can be considered a \textit{pointer} self-reference. The sentence \textit{this
...
and sentences for their meaning, and we use their representation to disseminate them.
